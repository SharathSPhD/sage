...
|---|---|---|---|
| R1 | Strategic resolvent: χ^eq = (I − SB)⁻¹S on the tangent space | Total differentiation of the fixed point; PROGRAMME v3 §3.3 | Likely folklore in some form — **cite defensively, don't claim**. **Numerically verified 2026-08-08**: matches central finite differences to 1.3e-8 on 50 random games (artifact `chi_fd_agreement.json`, unit finite.response.reciprocity) |
