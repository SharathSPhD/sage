...
\subsection{Conditional on \texorpdfstring{$\alpha$}{alpha}, the co-movement collapses}
\label{sec:collapse}
...
\subsubsection{The \texorpdfstring{$m$}{m}-trend is largely, not wholly, a normalised-precision effect}
...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{3.5cm}>{\raggedright\arraybackslash}p{4.3cm}>{\raggedright\arraybackslash}p{5.1cm}>{\raggedright\arraybackslash}p{2.5cm}@{}}
\toprule
