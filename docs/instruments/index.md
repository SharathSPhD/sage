...
- **[λ estimation](lambda.md)** — four routes to the rationality parameter and the agreement protocol (gate estimate.lambda).
- **[Market data](market-data.md)** — first real-data contact: CAISO prices through the dissipation meter, and the certified null F-0008 (gate domains.electricity).
